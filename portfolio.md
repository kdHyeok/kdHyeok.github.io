...
<style>
  ...
  .project-card:hover { transform: translateY(-5-px); box-shadow: 0 4px 15px rgba(0,0,0,0.1); }
  ...
  {% for item in site.data.github_data.projects %}
    <div class="project-card">
      ...
      <div class="links" style="margin-top: 15px;">
        <a href="{{ item.url }}" class="btn">GitHub</a>
        {% if item.homepage %}
          <a href="{{ item.homepage }}" class="btn btn-demo">Live Demo</a>
        {% endif %}
      </div>
    </div>
  {% endfor %}
